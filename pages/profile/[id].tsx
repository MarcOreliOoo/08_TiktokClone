...
//When we have a folder + [id].tsx we need to do some data fetching
// in nextjs it's done with getServerSideProps
// the params name has to be the same as it is inside the []
